...
IncrementalTriangulator::IncrementalTriangulator(const SceneGraph* scene_graph, Reconstruction* reconstruction)
...
size_t IncrementalTriangulator::CompleteImage(const Options& options, const image_t image_id) {
    options.Check();
...
size_t IncrementalTriangulator::CompleteTracks(const Options& options,
...
size_t IncrementalTriangulator::MergeTracks(const Options& options,
                                            const std::unordered_set<point3D_t>& point3D_ids) {
    options.Check();
...
size_t IncrementalTriangulator::Continue(const Options& options,
